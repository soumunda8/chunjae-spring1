...
public class SampleController {
    ...
    @RequestMapping("main.do")  // GET 방식, http://localhost:8081/pro3_war/sample/main.do
    public String sample(Locale locale, Model model) throws Exception {
        model.addAttribute("user", "몬스타엑스");
        return "/sample/main";
    }

    @GetMapping("get1.do")  // GET 방식 : <a href="/sample/get1.do?id=monstaX&pw=1234">Get 방식</a>
    ...
    // GET 방식에서 주로 활용하며, springboot 나 react 에서 전달 가능한 방식임
    ...
    // GET 방식에서 주로 활용하며, spring 에서만 저장 목적의 전달만 가능한 방식임
    @RequestMapping("post6.do/{id}/{pw}")
